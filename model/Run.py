...
Mode = 'train'
DEBUG = 'False'
DATASET = 'PEMSD4'      #PEMSD3, PEMSD4, metr-la, pems-bay, PEMSD7 or PEMSD8 
DEVICE = 'cuda:0'

#get configuration
config_file = './{}_AGCRN.conf'.format(DATASET)
...
args.add_argument('--model', default='MultiGraph', type=str)
#data
...
args.add_argument('--no_t', default=False, type=bool)
...
use_g = not args.no_g
use_t = not args.no_t
print('args.use_diff',use_diff)
print('args.use_g',use_g)
print('args.use_t',use_t)
model = MultiGraph(args.input_dim, args.output_dim, args.lag, args.horizon, args.num_nodes, embed_dim=args.embed_dim, use_diff=use_diff, use_g=use_g, use_t=use_t)
...
def loss_func(pred, target):
    ...
    if args.loss_func == 'mask_mae':
        ...
        raise ValueError
    return torch.relu(loss(pred, target))#-20)
...
if args.mode == 'train':
    ...
    model = torch.load("./experiments/PEMSD4/best_model.pth").to(args.device)
